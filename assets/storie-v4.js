...
const T = {
  it: {
    ...
    sensitiveNote: "🤖 I suggerimenti sono bozze di un sistema di IA basate solo sul tuo testo: rivedile. Non inserire dati sensibili (salute, religione, orientamento, opinioni politiche…): non servono; se li scrivi restano cifrati e non sono mai usati per valutarti o per addestrare modelli.",
  ...
  en: {
    ...
    sensitiveNote: "🤖 Suggestions are drafts from an AI system based only on your text: review them. Do not enter sensitive data (health, religion, orientation, political opinions…): not needed; if you type it, it stays encrypted and is never used to rate you or train models.",
